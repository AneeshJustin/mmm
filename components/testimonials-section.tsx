...
const testimonials = [
  {
    ...
    location: "Thrissur",
    religion: "Hindu",
    quote: "The Guruvayur temple design was exactly what we dreamed of. Our guests loved the digital invitation!",
    image: "hindu",
  },
  {
    name: "Fathima & Rashid",
    location: "Kozhikode",
    religion: "Muslim",
    quote: "Beautiful Malabar-style invitation that honored our traditions. The Islamic patterns were stunning.",
    image: "muslim",
  },
  {
    name: "Maria & Thomas",
    location: "Kottayam",
    religion: "Christian",
    quote: "Perfect Syrian Christian wedding invitation. The elegant design impressed everyone in our family.",
    image: "christian",
  },
]
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              {/* Quote Icon */}
              <svg className="w-10 h-10 text-kerala-gold/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h4 className="font-bold text-kerala-dark">{testimonial.name}</h4>
                  <p className="text-kerala-dark/50 text-sm">{testimonial.location} • {testimonial.religion} Wedding</p>
                </div>
              </div>
            </motion.div>
          ))}
...
function TestimonialAvatar({ religion }: { religion: string }) {
  ...
  return (
    <svg className={`w-6 h-6 ${colors[religion]}`} fill="currentColor" viewBox="0 0 24 24">
